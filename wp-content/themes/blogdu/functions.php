...
if ( ! class_exists( 'Blogdu_Toggle_Control' ) ) {
    ...
    $wp_customize->add_setting('blogdu_title_font_size',
        array(
            'default'           => 30,
    ...
    $wp_customize->add_control('blogdu_title_font_size',
        array(
...
function blogdu_header_color() {
    ...
    ?>
        ...
        .site-branding-text .site-title a {
                font-size: <?php echo esc_attr( $blogdu_title_font_size,30 ); ?>px;
            }
